...
import { BarChart3, Radio, Scale } from "lucide-react";
import "./globals.css";
      ...
      <body className="min-h-full flex flex-col bg-slate-950 text-slate-50">
        <nav className="sticky top-0 z-50 bg-slate-900/80 backdrop-blur-md border-b border-slate-800 px-6 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            {/* Logo wrapped in a Link returning to the Search Hub */}
            ...
            <div className="flex gap-4">
              ...
              <Link href="/trends" className="flex items-center gap-2 text-sm font-medium text-slate-300 hover:text-white transition-colors bg-slate-800/50 px-4 py-2 rounded-lg border border-slate-700/50">
              ...
              <Link href="/compare" className="flex items-center gap-2 text-sm font-medium text-slate-300 hover:text-white transition-colors bg-slate-800/50 px-4 py-2 rounded-lg border border-slate-700/50">
                <Scale size={16} className="text-purple-400" /> Compare
              </Link>
              <Link href="/feed" className="flex items-center gap-2 text-sm font-medium text-slate-300 hover:text-white transition-colors bg-slate-800/50 px-4 py-2 rounded-lg border border-slate-700/50">
                <Radio size={16} className="text-emerald-400" /> Live Listening
              </Link>
            </div>
